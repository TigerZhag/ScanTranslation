...
class Tesseract : public Wordrec {
 public:
  ...
  int init_tesseract(const char *datapath,
					 ...
					 const char* suffix,
                     OcrEngineMode oem) {
    return init_tesseract(datapath, NULL, language,suffix, oem,
  ...
  BOOL_VAR_H(textord_use_cjk_fp_model, true, "Use CJK fixed pitch model");
  ...
  vector<CornerCoordinate> moVectorCoordinate;
  vector<CornerCoordinate> moVectorPreCoordinate;
