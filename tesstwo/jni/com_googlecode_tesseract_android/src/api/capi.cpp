...
TESS_API int TESS_CALL TessBaseAPIInit4(TessBaseAPI* handle, const char* datapath, const char* language,const char* suffix,
    ...
    BOOL set_only_non_debug_params)
{
    ...
    return handle->Init(datapath, language,suffix, mode, configs, configs_size, &varNames, &varValues, set_only_non_debug_params);
}


TESS_API int TESS_CALL TessBaseAPIInit1(TessBaseAPI* handle, const char* datapath, const char* language, const char* suffix,TessOcrEngineMode oem,
                                        char** configs, int configs_size)
{
    return handle->Init(datapath, language, suffix,oem, configs, configs_size, NULL, NULL, false);
}

TESS_API int TESS_CALL TessBaseAPIInit2(TessBaseAPI* handle, const char* datapath, const char* language,const char* suffix, TessOcrEngineMode oem)
{
    return handle->Init(datapath, language,suffix, oem);
}

TESS_API int TESS_CALL TessBaseAPIInit3(TessBaseAPI* handle, const char* datapath, const char* language,const char* suffix)
{
    return handle->Init(datapath, language,suffix);
}
